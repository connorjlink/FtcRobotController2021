...
@Autonomous(name="Red B Autonomous")
    ...
    public void runOpMode()
    {
        ...
        switch (detector.data)
        {
            ...
            case "l":
                ...
                encoderDrive(robot.DRIVE_SPEED / 2.0, 9.5, -9.5, 9.5, -9.5, 1000);
                encoderDrive(robot.DRIVE_SPEED / 2.0, -5.2, -5.2, -5.2, -5.2, 1000);
                ...
                //encoderDrive(robot.DRIVE_SPEED / 2.0, 13.0, -13.0, 13.0, -13.0, 1000);
                //encoderDrive(robot.DRIVE_SPEED, 35.0, 35.0, 35.0, 35.0, 1000);


                encoderDrive(robot.DRIVE_SPEED / 2.0, -10.0, -10.0, -10.0, -10.0, 1000);
                encoderDrive(robot.DRIVE_SPEED / 2.0, 10.0, -10.0, 10.0, -10.0, 1000);
                encoderDrive(robot.DRIVE_SPEED, 40.0, 40.0, 40.0, 40.0, 1000);
                break;
                */
            ...
            case "r":
                ...
                encoderDrive(robot.DRIVE_SPEED / 2.0, -6.0, -6.0, -6.0, -6.0, 1000);
                encoderDrive(robot.DRIVE_SPEED / 2.0, -5.0, 5.0, -5.0, 5.0, 1000);
                encoderDrive(robot.DRIVE_SPEED / 2.0, -15.25, -15.25, -15.25, -15.25, 1000);
                ...
                encoderDrive(robot.DRIVE_SPEED / 2.0, 7.0, 7.0, 7.0, 7.0, 1000);
                encoderDrive(robot.DRIVE_SPEED / 2.0, 14.0, -14.0, 14.0, -14.0, 1000);
                encoderDrive(robot.DRIVE_SPEED, -25.0, -25.0, -25.0, -25.0, 1000);
                encoderDrive(robot.DRIVE_SPEED / 2.0, 2.0, -2.0, 2.0, -2.0, 1000);
                break;
                */
